...
export function TiktokIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" {...props}>
      <path d="M19.6 6.4a5.7 5.7 0 0 1-3.4-1.1 5.7 5.7 0 0 1-2.2-3.3h-3.2v12.7a2.3 2.3 0 1 1-2.3-2.2 2.3 2.3 0 0 1 .7.1V9.2a5.6 5.6 0 0 0-.7-.1 5.5 5.5 0 0 0 0 11.1 5.5 5.5 0 0 0 5.5-5.5V8.3a8.8 8.8 0 0 0 5.6 2c.2 0 .3 0 .5-.1V7.1s0-.1-.2-.7z" />
    </svg>
  );
}
...
export function RumbleIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" {...props}>
      <path d="M18.8 4.2C15.6 1 10.4 1 7.2 4.2L2.7 8.7c-3.6 3.6-3.6 9.4 0 13 3.2 3.2 8.4 3.2 11.6 0l4.5-4.5c3.6-3.6 3.6-9.4 0-13z" />
    </svg>
  );
}
...
export function PanelLeftCloseIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
      <rect width="18" height="18" x="3" y="3" rx="2" />
      <path d="M9 3v18" />
...
export function PaletteIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
      ...
      <path d="M12 2C6.5 2 2 6.5 2 12s4.5 10 10 10c.92 0 1.7-.65 1.96-1.54.16-.54.67-.96 1.24-.96h1.8c2.2 0 4-1.8 4-4 0-.46-.08-.9-.23-1.31C20.3 12.8 21 11.5 21 10c0-4.4-4-8-9-8z" />
    </svg>
  );
}
...
export function CheckCheckIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
