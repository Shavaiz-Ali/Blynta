...
const appButtonVariants = cva("", {
  variants: {
    variant: {
      ...
      link: "",
      social:
        "w-full justify-center items-center gap-2 bg-card/60 hover:bg-accent text-foreground font-semibold border border-border/80 hover:border-border/90 shadow-sm h-10 px-4 rounded-xl transition-all",
    },
  },
  defaultVariants: {
    variant: "default",
...
const appVariantToShadcn: Partial<Record<
  NonNullable<VariantProps<typeof appButtonVariants>["variant"]>,
  ShadcnButtonVariant
>> = {
  default: "default",
...
const AppButton = React.forwardRef<HTMLButtonElement, AppButtonProps>(
  (
    ...
    const resolvedIcon: React.ReactNode =
      socialProvider != null ? socialIcons[socialProvider] : icon;
